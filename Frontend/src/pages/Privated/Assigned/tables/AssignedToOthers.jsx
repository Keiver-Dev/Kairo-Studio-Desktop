...
const CommentRow = ({ comment, onToggle, index }) => {
    ...
    return (
        <div
            ...
            style={{
                borderLeft: isResolved ? "none" : `3px solid ${accentColor}`,
            }}
        >
            <button
...
const AssignedToOthers = () => {
    ...
    const otherComments = comments.filter((c) => !c.assignedToMe);
    ...
    const pendingComments = otherComments.filter((c) => !c.resolved);
    const resolvedComments = otherComments.filter((c) => c.resolved);
    ...
    return (
        <div className="flex flex-col h-full w-full overflow-auto">
            ...
            <div className="px-4 py-2 text-xs flex items-center gap-2">
                <span style={{ color: "#FFB175" }}>{otherComments.length} comments</span>
...
export default AssignedToOthers;